...
async function main() {
    ...
    // Dai has 18 decimals similar to wei so still have to convert to wei
...
async function getLendingPool(account) {
    const lendingPoolAddressesProvider = await ethers.getContractAt( "ILendingPoolAddressesProvider", networkConfig[network.config.chainId].lendingPoolAddressesProvider, account )
